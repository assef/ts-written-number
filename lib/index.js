...
/**
 * 
 * @param {string} lang The language to import
 * @returns The language object
 */
function importTranslateStringsByLanguage(lang) {
  return require(i18n[lang]);
}
...
function writtenNumber(n, options) {
  ...
  var language = typeof options.lang === "string"
    ? importTranslateStringsByLanguage(i18n[options.lang] ? options.lang : "en")
    : options.lang;
